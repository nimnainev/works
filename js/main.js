...
$(document).ready(function () {
  $(".projectSection .btnb").click(function (e) {
    e.preventDefault();
    var btn = $(this);
    btn.toggleClass("open");
    var cur_text = btn.find("span").text();
    var new_text = btn.find("span").data("swap-text");
    btn.find("span").text(new_text);
    btn.find("span").data("swap-text", cur_text);
    btn.closest(".projectSection").find(".wrap").slideToggle(750, "swing");
  });
});
...
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.doctors__content', {
  // slidesPerView: 'auto',
  slidesPerView: 5,
  spaceBetween: 40,
  navigation: {
